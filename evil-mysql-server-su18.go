...
var ysoserialPath = flag.String("yso", "ysoserial-0.0.6-SNAPSHOT-all.jar", "ysoserial bin path")
var ysuserialPath = flag.String("ysu", "ysuserial-1.5-su18-all.jar", "ysuserial bin path")
var ysu_url = flag.String("url", "/testbin", "ysuserial bin path")
var ysu_pw = flag.String("pw", "p@ssw0rd", "Behinder or Godzilla password")
var ysu_hv = flag.String("hv", "https://www.google.com/", "MemoryShell binding url pattern")
